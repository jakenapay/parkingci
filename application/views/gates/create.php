        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Add Gate</h3>
            </div>
            <form role="form" action="<?php base_url('gate/create') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="gate_name" name="gate_name" placeholder="Gate name">
                </div>
                <div class="form-group">
