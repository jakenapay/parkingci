<style>
    ...
    .voucher-info {
      display: none; /* Initially hidden until voucher is validated */
      background: #f4f4f4;
...
<section class="content-wrapper">
    ...
    <div class="instructions">
      Please enter your voucher code to validate your complimentary ticket. The code can be found on your ticket or in your email confirmation.
    </div>
    ...
    <!-- Voucher Input Section -->
     ...
     <!-- <input type="hidden" name="parking_id" class="form-control" value="<?php echo $details['id']; ?>">
                    ...
                    <input type="text" name="discounted" class="form-control"
                        value="<?php echo $details['amountAfterDiscount']; ?>">
                    <input type="text" name="discounted_amount" class="form-control"
                        value="<?php echo $details['discountAmount']; ?>">
     ...
     <div class="voucher-input-section">
      <div class="input-group">
        ...
        <input type="text" placeholder="e.g., COMP-2024-XXXX" maxlength="16">
      </div>
