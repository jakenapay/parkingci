    ...
    <div class="content">
        <div class="col-md-5">
            <div class="payment-box">
                ...
                <form action="<?php echo base_url("demo/paymodeprocess"); ?>" method="POST">
                    ...
                    <input type="text" name="custname" class="form-control" value="<?php echo !empty($details['name']) ? $details['name'] : 'N/A'; ?>">

                    <input type="text" name="custaddress" class="form-control" value="<?php echo !empty($details['address']) ? $details['address'] : 'N/A'; ?>">

                    <input type="text" name="custtin" class="form-control" value="<?php echo !empty($details['tin']) ? $details['tin'] : 'N/A'; ?>">

                    <input type="text" name="custidnumber" class="form-control" value="<?php echo !empty($details['idnumber']) ? $details['idnumber'] : 'N/A'; ?>">
