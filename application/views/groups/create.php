                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Gate</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createGate"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateGate"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewGate"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteGate"></td>
                      </tr>
                      <tr>
                        <td>RFID</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createRfid"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateRfid"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewRfid"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteRfid"></td>
                      </tr>
                      <tr>
                        <td>Company</td>
                        <td> - </td>
