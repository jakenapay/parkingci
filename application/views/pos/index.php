...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Touchpoint v1.0 <small>Manage dashboard</small></h1>
        <ol class="breadcrumb">
            ...
            <div class="col-md-4">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="<?php echo base_url('touchpoint/transactions'); ?>" class="pull-right btn btn-primary">View All</a>
                    </div>
                    <div class="box-body">
                        <?php foreach($recentTransaction as $row): ?>
                            <div class="row-transaction-data">
                                <div>
                                    <h5 class="mb-0">Code: <?php echo $row['parking_code']; ?></h5> <!-- Fixed closing tag -->
                                    <p class="text-muted">Duration: <?php echo $row['total_time']; ?></p>
                                </div>
                                <div class="text-end" style="margin-left: auto;">
                                    <h5 class="mb-0">₱ <?php echo number_format($row['earned_amount'], 2); ?></h5>
