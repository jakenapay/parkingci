  ...
  <div class="content">
    <div class="col-md-5">
      <form action="<?php echo base_url("touchpoint/processTransaction"); ?>" method="POST">
        ...
        <!-- <input type="text" name="total_sales" class="form-control" value="<?php echo $details['amountDue']; ?>"> -->
        <!-- <input type="text" name="paymentmode" class="form-control" value="<?php echo $details['paymode']; ?>"> -->
        <input type="text" name="qrphref" class="form-control" value="<?php echo $details['refnumber']; ?>">
        ...
        <input type="text" name="paymentmode" class="form-control" value="<?php echo $details['paymode']; ?>">
        <input type="text" name="salesamount" class="form-control" value="<?php echo number_format($details['totalSales'], 2); ?>">
