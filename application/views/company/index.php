            ...
            <form role="form" action="<?php base_url('company/') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="telephone" class="form-control" id="telephone" name="telephone" placeholder="telephone" value="<?php echo ($this->input->post('telephone')) ?:$company_data['telephone']; ?>">
                </div>
                <div class="form-group">
                  <label for="message">TIN </label>
                  <input type="text" class="form-control" id="TIN" name="TIN" placeholder="TIN" value="<?php echo ($this->input->post('TIN')) ?:$company_data['TIN']; ?>">
                </div>
                <div class="form-group">
                  <label for="message">MIN</label>
                  <input type="text" class="form-control" id="MIN" name="MIN" placeholder="MIN" value="<?php echo ($this->input->post('MIN')) ?:$company_data['MIN']; ?>">
                </div>
