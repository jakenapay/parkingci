...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body">
      <img  class="center" style="width: 100%; height: auto; max-width: 100%; display: block; margin: 0 auto;" src="<?= base_url('assets/images/logo.png') ?> " >      
      ...
      <form action="<?php echo base_url('touchpoint/setBalance') ?>" method="POST">
