      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          <div class="box">
            ...
            <form onsubmit="return event.keyCode != 13;" action="<?php echo base_url('mobile/pmethods') ?>" method="post"> 
              <div class="box-body">  
                ...
                <div class="form-group col-md-6">                
                  ...
                  <input type="text" class="form-control" id="plate" name="plate" placeholder="plate" value="<?php echo ($this->input->post('plate'))?:$parking_data['plate']; ?>" readonly>
                </div>                
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" id="d_option" name="d_option"  value="regular" readonly>                     
                ...
                <div class="box-footer">                  
                  <div class="form-check  form-check-inline" >
                    <div class="form-group col-md-6">                                      
                      ...
                      <input class="form-check-input" type="radio" name="paysolution" id="Complimentry" value="Complimentry" >
