          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('slots/create') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="group_name">Number of slot</label>
                  <input type="number" class="form-control" id="slot_no" name="slot_no" placeholder="Slot capacity">
                </div>
                <div class="form-group">
                  <label for="group_name">Occupied slot</label>
                  <input type="number" class="form-control" id="slot_occ" name="slot_occ" placeholder="Slots occupied">
                </div>
                <div class="form-group">
