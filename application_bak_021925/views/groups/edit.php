                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Gate</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createGate" <?php 
                        if($serialize_permission) {
                          if(in_array('createGate', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateGate" <?php 
                        if($serialize_permission) {
                          if(in_array('updateGate', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewGate" <?php 
                        if($serialize_permission) {
                          if(in_array('viewGate', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteGate" <?php 
                        if($serialize_permission) {
                          if(in_array('deleteGate', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                      </tr>
                      <tr>
                        <td>RFID</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createRfid" <?php 
                        if($serialize_permission) {
                          if(in_array('createRfid', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateRfid" <?php 
                        if($serialize_permission) {
                          if(in_array('updateRfid', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewRfid" <?php 
                        if($serialize_permission) {
                          if(in_array('viewRfid', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteRfid" <?php 
                        if($serialize_permission) {
                          if(in_array('deleteRfid', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                      </tr>
                      <tr>
                        <td>Complimentary</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createComp" <?php 
                        if($serialize_permission) {
                          if(in_array('createComp', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateComp" <?php 
                        if($serialize_permission) {
                          if(in_array('updateComp', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewComp" <?php 
                        if($serialize_permission) {
                          if(in_array('viewComp', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteComp" <?php 
                        if($serialize_permission) {
                          if(in_array('deleteComp', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                      </tr>
