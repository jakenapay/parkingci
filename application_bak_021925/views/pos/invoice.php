    ...
    <div class="content">
        ...
        <div class="receipt">
            ...
            <div class="details">
                ...
                <div>Date and Time: <?php date_default_timezone_set("Asia/Manila"); echo date("m-d-Y h:i:s A", $receipt['paymentTime']) ?></div>
                </div>
                <div class="row-center-data">
            ...
            <div class="details">
                ...
                <div class="row-data">
                    <span>Bill Time:</span>
                    <span><?= date('Y-m-d H:i:s A', $receipt['paymentTime']); ?></span>
                </div>
                <div class="row-data">
                ...
                <div class="row-data">
                    ...
                    <span>₱<?= number_format($receipt['totalSales'], 2) ?></span>
                </div>
                <div class="row-data">
                    <span>Vat (12%):</span>
                ...
                <div class="row-data">
                    ...
                    <span>₱<?= number_format($receipt['cashReceived'], 2) ?></span>
                </div>
                <div class="row-data">
                    <span>Change Amount:</span>
                    <span>₱<?= number_format($receipt['changeDue'], 2) ?></span>
                </div>
            </div>
            ...
            <div class="details">
                ...
                <div class="row-data">
                    ...
                    <div>₱<?= number_format($receipt['nonVat'], 2) ?></div>
                </div>
                <div class="row-data">
                    <div>Vat-Exempt:</div>
            ...
            <div class="footer">
                ...
                THIS SERVER AS YOU SALES INVOICE</p>
            </div>
        </div>
    </div>
</section>
