<section class="content-wrapper">
    ...
    <div class="cash-register-container">
        <form action="<?php echo base_url("touchpoint/processTransaction") ?>" method="POST">
                    ...
                    <input type="hidden" name="total_sales" class="form-control"
                        value="<?php echo $details['amountDue']; ?>">
                    <input type="hidden" name="paymentmode" class="form-control"
                ...
                <div class="left-panel">
                    <div class="amount-section">
                        <div class="amount-display">
                            ...
                            <input type="text" id="total" value="<?php echo number_format($details['amountDue'], 2); ?>" readonly>
                        </div>
                        <div class="amount-display">
                            <label>Cash Received ($)</label>
                            <input type="text" name="cash_received" id="received" placeholder="100,200,300">
                        </div>
                        <div class="change-display">
                            <label>Change Due (₱)</label>
                            <input type="text" name="change_due" class="change-amount" placeholder="0" readonly>
                            <div id="remainingBalance" style="display: none;"><?php echo $remaining_balance; ?></div>
                    ...
                    <div class="payment-summary">
                        ...
                        <div class="summary-row">
                            <span>Rate</span>
                            <span><?php echo $details['parking_status'] ?></span>
                        </div>
                        <div class="summary-row">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Get remaining balance from the hidden div
    ...
    const cashDrawerBalanceElement = document.getElementById('cash-drawer-balance');
    ...
    function calculateChange() {
        ...
        const cashDrawerBalance = parseFloat(remainingBalance);

        if (change > cashDrawerBalance) {
