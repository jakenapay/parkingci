...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
    Total Statistical Reports
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Total Statistical Reports</li>
    </ol>
  </section>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Total Statistical Report</h3>
          </div>
          <!-- /.box-header -->
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Daily Statistical Report Data</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
