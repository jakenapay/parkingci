    ...
    <div class="content">
        <div class="col-md-5">
          ...
          <input type="hidden" name="parking_id" class="form-control" value="<?php echo $details['id']; ?>">
                    ...
                    <input type="hidden" name="discountopt" class="form-control"
                        value="<?php echo $details['discountopt']; ?>">


                    <input type="hidden" name="nonvat" class="form-control"
                        value="<?php echo $details['non_vat']; ?>">
                    <input type="hidden" name="discounted" class="form-control"
                        value="<?php echo $details['discount']; ?>">
                    <input type="hidden" name="amount_due" class="form-control"
                        value="<?php echo $details['amount_due']; ?>">
                    <input type="hidden" name="qrphamount" class="form-control"
                      value="<?php echo $details['qrphamount']; ?>">
                    <input type="text" name="qrphref" class="form-control"
                      value="<?php echo $details['refNumber']; ?>">
