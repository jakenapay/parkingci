        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <!-- Form Start -->
                        <form action="<?php echo base_url("demo/modeofpayment"); ?>" method="post">
                            <div class="parking-session">
                                ...
                                <div class="info-row">
                                    <span class="info-label">Payment Time:</span>
                                    <span
                                        class="info-value"><?php echo $details['parking_amount']; ?></span>
                                </div>
                                ...
                                <div class="discount-section">
                                    <?php if (isset($validation_errors)): ?>
                                        ...
                                        <script>
                                            // Use JavaScript to hide the error message after 3 seconds
                                            setTimeout(function() {
                                    ...
                                    <select id="discount" name="discount" onchange="toggleAdditionalFields()">
                                    ...
                                    <div id="additionalFields" style="display: none; margin-top: 15px;">
                                        ...
                                        <input type="text" id="custtin" name="custtin" class="form-control"
                                            placeholder="Enter TIN">

                                        <label for="idNumber">ID</label>
                                        <input type="text" id="custidnumber" name="custidnumber" class="form-control"
