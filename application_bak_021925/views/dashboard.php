      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-12">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo $total_parking[0]['vacant']; ?> / <?php echo $total_parking[0]['num_slot']; ?></h3>
              <p>Available Parking Slots</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-12">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3><?php echo $total_parking[1]['vacant']; ?> / <?php echo $total_parking[1]['num_slot']; ?></h3>
	...
	<div class="row">                
        <div class="col-lg-3 col-xs-12">
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php echo $gate[0]['name'] ?></h3>
              <p><?php echo $gate[0]['status'] ?></p>
            </div>
            <div class="icon">
              <i class="ion boom-gate-up-icon"></i>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-12">
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php echo $gate[1]['name'] ?></h3>
              <p><?php echo $gate[1]['status'] ?></p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-12">
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php echo $gate[2]['name'] ?></h3>
              <p><?php echo $gate[2]['status'] ?></p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-speedometer-outline"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-12">
          <div class="small-box bg-blue">
            <div class="inner">
              <h3><?php echo $gate[3]['name'] ?></h3>
              <p><?php echo $gate[3]['status'] ?></p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-speedometer-outline"></i>
            </div>
