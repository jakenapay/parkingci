...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="btn-group">
          <a href="<?= base_url('cashier/transaction');?>" class="btn btn-primary">Cashier Transactions</a>
          <a href="<?= base_url('cashier/kioskTransaction'); ?>" class="btn btn-light">Paystation Transactions</a>
        </div>
        <br>
    </section>
    <br>
