...
class Admin_Controller extends MY_Controller 
{
	...
	public $totalslot =700, $occupied =0, $vaccant =0;
	...
	public function render_template($page = null, $data = array())
	{
		...
		if($position =='cashier'){    
			$this->load->view('templates/touchpoint_menubar',$data);
		}else if($position == '16')
		{
			$this->load->view('templates/treasury_menu',$data);
		}
		else{
	...
	public function render_template2($page = null, $data = array())
	{
		...
		$this->load->view('templates/header',$data);
		$this->load->view('templates/header_menu',$data);	
		$this->load->view('templates/cashier_menubar',$data);	
		$this->load->view($page, $data);
		$this->load->view('templates/footer',$data);
	}
